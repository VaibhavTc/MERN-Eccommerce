      ...
      <Layout>
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              >
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          required
                          {...register2("pinCode", {
                            required: "ZIM / Postal Code is required",
                          })}
                        />
                      </div>
                      {errors2.pinCode && (
                  ...
                  <div className="w-full text-right">
                    <button
                      onClick={() => reset2(undefined, { keepErrors: false })}
                      className="rounded-md m-5 px-3 py-2 text-sm font-semibold text-indigo-600 hover:text-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                      Reset
                    </button>
                    <button
                            ...
                            >
                              <div className="flex min-w-0 gap-x-4 text-left">
                                <div className="min-w-0 flex-auto">
                                  ...
                                  <p className="ktruncate text-xs leading-5 text-gray-500">
          ...
          <div className="lg:col-span-2 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 bg-white h-max">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 text-left pt-5 pl-5">
              Cart
            </h1>
                          ...
                          <div className="flex flex-1 items-end justify-between text-sm">
                            ...
                            <div className="flex">
                              <div className="mx-2">
                                ...
                                <input
                                  id="counter"
                                  className="mx-1 p-1 border border-gray-300 rounded text-center w-16"
                                  type="text"
                                  value={item.quantity}
                                  onChange={(e) => {
                              ...
                              <button
                                onClick={() => {
                                  dispatch(
                                    deleteFromCart([item.user, item.id])
                                  );
                                }}
